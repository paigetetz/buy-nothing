...
u1= User.create(username:"user", password:"1234", email: "cerimay@gmail.com", profile_pic:"https://i.natgeofe.com/k/5af79b71-007d-46f8-8efe-bf37a504195b/california-golden-gate-bridge.jpg")
...
e1= Event.create(name:"AthenaHacks", location:"Los Angeles, CA", description:"Southern California’s premier hackathon for women and individuals with marginalized gender identities!", time:"10am PST", date: 02/25/2023, user_id: u1.id)
