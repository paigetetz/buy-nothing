  ...
  return (
    ...
    <div>
      <div className="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
        <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-[60rem] overflow-hidden h-[43rem]">
          <div className="md:flex w-full">
            <div className="hidden md:block w-1/2 bg-secondary py-10 px-10 h-[45rem]">
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <div className="w-full px-3">
                    ...
                    <div className="flex">
                      ...
                      <input type="text"
                        ...
                        value={username}
                        onChange={(e) => setUsername(e.target.value)}
                        className="w-full -ml-10 pl-2 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-secondary" placeholder="smith" />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <label for="username" className="text-xs font-semibold px-1">Email</label>
                    <div className="flex">
                      <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                      <input type="email" className="w-full -ml-10 pl-2 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-secondary" placeholder="smith@exa.com" />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <label for="password" className="text-xs font-semibold px-1">Password</label>
                    <div className="flex">
                      ...
                      <input type="password"
                        ...
                        onChange={(e) => setPassword(e.target.value)}
                        autoComplete="current-password"
                        className="w-full -ml-10 pl-2 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-secondary" placeholder="password" />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <label for="password_confirmation" className="text-xs font-semibold px-1">Password Confirmation</label>
                    <div className="flex">
                      <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                      <input type="password"
                        id="password_confirmation"
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <label for="bio" className="text-xs font-semibold px-1">Write a Short Bio</label>
                    <div className="flex">
                      <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                      <input class="bio"
                        type="text"
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <label for="profile_pic" className="text-xs font-semibold px-1">Upload Profile Picture</label>
                    <div className="flex">
                      <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                      <input
                        class="profile-pic"
                        ...
                        value={profile_pic}
                        onChange={(e) => setProfilePic(e.target.value)}
                        className="w-full -ml-10 pl-2 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-secondary" placeholder="Short Bio" />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-3">
                    <button type="submit" className="block w-full max-w-xs mx-auto bg-primary text-white rounded-lg px-3 py-3 font-semibold">Sign In</button>
                  </div>
                </div>
